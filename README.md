...
| HTTP Method | Endpoint           | Description                     | Request Body/Query Parameters                                                                                          | Example Response                                           |
|-------------|--------------------|---------------------------------|------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|
| `POST`      | `/api/v1/transfers`        | Creates a Transfer between sender and receiver               | `{"receiverId": "c1f74b35-d99c-4c49-9a2d-54a82440982e","amount": 1,"description": "A payment for the service"}`                                    | `{"id": "d69b5a20-02e6-11eb-adc1-0242ac120002", "amount": 100, "sender": "<User>", "receiver": "<User>", created_at": "2024-10-04T12:34:56Z","updated_at": "2024-10-04T12:34:56Z"}`            |
